//
//  PickerTextFieldCellViewModel.swift
//  Form
//
 ...
 */
class PickerTextFieldCellViewModel: CellViewModelType, PickerTextFieldCellDelegate {
    ...
    init<vc: UIViewController>(viewController: vc, cellData: CellDataType) where vc: FormViewControllerType  {
        ...
        tableView.register(UINib(nibName: "PickerTextFieldCell", bundle: nil), forCellReuseIdentifier: "PickerTextFieldCell")
    }
    ...
    func createCell(indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "PickerTextFieldCell", for: indexPath) as? PickerTextFieldCell,
            let cellData = cellData as? PickerTextFieldCellData {
